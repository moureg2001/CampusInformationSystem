...
public class Contents implements Serializable{
    ...
    public Contents(String name, String format,long abspielZeit, String pfad,  boolean isText, boolean isPicture, boolean isVideo, boolean isYoutube, boolean isRss) {
        this.name = name;
        this.format = format;
